...
const exerciseLibrary = [
    { name: "Bench Press", type: "Gym", category: "chest", met: 6.0, muscle: "Chest, Triceps, Shoulders", img: "assets/muscle_chest.png", instruction: "Lie flat on a bench. Grip barbell slightly wider than shoulder-width, lower barbell slowly to chest level, then push it back up with control." },
    { name: "Incline Dumbbell Press", type: "Gym", category: "chest", met: 6.0, muscle: "Chest (Upper), Shoulders, Triceps", img: "assets/muscle_chest.png", instruction: "Position incline bench at 30-45 degrees. Grip dumbbells, start at shoulders, press straight up and meet at center without locking out." },
    { name: "Squats", type: "Gym", category: "legs", met: 5.5, muscle: "Quads, Glutes, Hamstrings", img: "assets/muscle_legs.png", instruction: "Position barbell on shoulder traps. Stand feet shoulder-width, bend hips back and knees forward until thighs are parallel to ground, then drive back up." },
    { name: "Deadlifts", type: "Gym", category: "legs", met: 6.0, muscle: "Back (Lower), Hamstrings, Glutes", img: "assets/muscle_legs.png", instruction: "Stand feet hip-width. Bend and grip barbell. Lift bar vertically by driving legs down and extending hips at top, keeping bar close to shins." },
    { name: "Pull-ups", type: "Gym", category: "back", met: 6.0, muscle: "Back (Lats), Biceps, Forearms", img: "assets/muscle_back.png", instruction: "Hang from pull-up bar with overhand grip wider than shoulders. Pull body up until chin clears bar, lower body with control." },
    { name: "Overhead Press", type: "Gym", category: "shoulders", met: 5.0, muscle: "Shoulders, Triceps, Core", img: "assets/muscle_shoulders.png", instruction: "Hold barbell at shoulder height, rack position. Press bar directly overhead, pushing head forward slightly at lock-out." },
    { name: "Bicep Curls", type: "Gym", category: "arms", met: 3.0, muscle: "Biceps, Brachialis", img: "assets/muscle_arms.png", instruction: "Stand straight, grip dumbbells with palms facing up. Keeping elbows close to ribs, curl weight up towards shoulders. Squeeze at top." },
    { name: "Lateral Raises", type: "Gym", category: "shoulders", met: 3.0, muscle: "Shoulders (Lateral), Traps", img: "assets/muscle_shoulders.png", instruction: "Stand holding dumbbells at sides. Raise arms out to sides with slight elbow bend until parallel to floor, then slowly lower." },
    { name: "Tricep Pushdowns", type: "Gym", category: "arms", met: 3.5, muscle: "Triceps", img: "assets/muscle_arms.png", instruction: "Attach rope to high pulley. Grip rope, keep elbows pinned to ribs, extend arms down by engaging triceps, then return slowly." },
    { name: "Running", type: "Cardio", category: "cardio", met: 9.8, muscle: "Legs, Heart, Lungs", img: "assets/muscle_legs.png", instruction: "Continuous steady-state outdoor or treadmill running. Promotes high cardiovascular endurance." },
    { name: "Cycling", type: "Cardio", category: "cardio", met: 7.5, muscle: "Quads, Hamstrings, Heart", img: "assets/muscle_legs.png", instruction: "Steady-state bicycle riding. Build endurance and burns calories with low impact on joints." },
    { name: "Swimming", type: "Cardio", category: "cardio", met: 8.0, muscle: "Full Body, Back, Shoulders", img: "assets/muscle_chest.png", instruction: "Steady lap swimming in a pool. Targets upper body and cardiovascular conditioning." },
    { name: "Jump Rope", type: "Cardio", category: "cardio", met: 10.0, muscle: "Calves, Delts, Cardiovascular", img: "assets/muscle_legs.png", instruction: "Continuous jump-rope skipping. Promotes rapid agility, calf strength, and calorie burn." },
    { name: "HIIT Cardio", type: "Cardio", category: "cardio", met: 8.0, muscle: "Full Body, Cardiovascular", img: "assets/muscle_back.png", instruction: "High intensity workout interval rounds. Alternates maximum efforts with recovery periods." },
    { name: "Air Bike", type: "Cardio", category: "cardio", met: 8.5, muscle: "Quads, Hamstrings, Cardiovascular", img: "assets/muscle_legs.png", instruction: "Sit on the air/fan bike, grip handles, pedal while pushing/pulling handles in a steady rhythm. Resistance scales with your effort, great for intervals." },
    { name: "Rowing Machine", type: "Cardio", category: "cardio", met: 8.5, muscle: "Back, Legs, Cardiovascular", img: "assets/muscle_back.png", instruction: "Sit on rower, drive through legs first, then lean back and pull handle to chest. Reverse the order returning to start position." },
    { name: "Stair Climbing", type: "Cardio", category: "cardio", met: 9.0, muscle: "Glutes, Quads, Cardiovascular", img: "assets/muscle_legs.png", instruction: "Continuous stair machine or real-stair climbing at a steady pace, driving through the heel of each step." },
    { name: "Push-ups", type: "Gym", category: "chest", met: 8.0, muscle: "Chest, Triceps, Shoulders", img: "assets/muscle_chest.png", instruction: "Start in plank position, hands slightly wider than shoulders. Lower chest to floor keeping body straight, then push back up." },
    { name: "Cable Chest Fly", type: "Gym", category: "chest", met: 4.0, muscle: "Chest (Inner), Shoulders", img: "assets/muscle_chest.png", instruction: "Stand between cable towers, grip handles. Bring hands together in a wide arc in front of chest, squeeze, then return slowly." },
    { name: "Dips", type: "Gym", category: "chest", met: 6.0, muscle: "Chest (Lower), Triceps, Shoulders", img: "assets/muscle_chest.png", instruction: "Support body on parallel bars, lower until elbows reach 90 degrees leaning slightly forward, then press back up." },
    { name: "Bent-over Barbell Row", type: "Gym", category: "back", met: 6.0, muscle: "Back (Lats, Mid), Biceps", img: "assets/muscle_back.png", instruction: "Hinge at hips holding barbell, back flat. Pull bar towards lower ribs squeezing shoulder blades, then lower with control." },
    { name: "Lat Pulldown", type: "Gym", category: "back", met: 5.0, muscle: "Back (Lats), Biceps", img: "assets/muscle_back.png", instruction: "Sit at lat pulldown machine, grip bar wide. Pull bar down to upper chest, squeezing lats, then let it rise back with control." },
    { name: "Seated Cable Row", type: "Gym", category: "back", met: 5.0, muscle: "Back (Mid), Lats, Biceps", img: "assets/muscle_back.png", instruction: "Sit at cable row station, feet on platform. Pull handle to torso keeping back straight, squeeze shoulder blades, release slowly." },
    { name: "Dumbbell Shrugs", type: "Gym", category: "back", met: 3.5, muscle: "Traps", img: "assets/muscle_back.png", instruction: "Hold dumbbells at sides, shrug shoulders straight up towards ears, pause briefly, then lower with control." },
    { name: "Dumbbell Lunges", type: "Gym", category: "legs", met: 5.0, muscle: "Quads, Glutes, Hamstrings", img: "assets/muscle_legs.png", instruction: "Hold dumbbells at sides, step forward into a lunge until both knees reach 90 degrees, push back to start, alternate legs." },
    { name: "Leg Press", type: "Gym", category: "legs", met: 5.0, muscle: "Quads, Glutes, Hamstrings", img: "assets/muscle_legs.png", instruction: "Sit in leg press machine, feet shoulder-width on platform. Lower weight by bending knees to 90 degrees, then press back up." },
    { name: "Leg Extension", type: "Gym", category: "legs", met: 4.0, muscle: "Quads", img: "assets/muscle_legs.png", instruction: "Sit on leg extension machine, pad on shins. Extend legs straight out squeezing quads, then lower with control." },
    { name: "Leg Curls", type: "Gym", category: "legs", met: 4.0, muscle: "Hamstrings", img: "assets/muscle_legs.png", instruction: "Lie face down on leg curl machine, pad on ankles. Curl heels towards glutes squeezing hamstrings, then lower slowly." },
    { name: "Calf Raises", type: "Gym", category: "legs", met: 3.5, muscle: "Calves", img: "assets/muscle_legs.png", instruction: "Stand on edge of a step or calf machine, rise up onto toes as high as possible, pause, then lower heels below the step level." },
    { name: "Romanian Deadlift", type: "Gym", category: "legs", met: 5.5, muscle: "Hamstrings, Glutes, Lower Back", img: "assets/muscle_legs.png", instruction: "Hold barbell, soft knees. Hinge at hips pushing glutes back, lower bar along legs until hamstring stretch, then drive hips forward." },
    { name: "Arnold Press", type: "Gym", category: "shoulders", met: 5.0, muscle: "Shoulders (All heads), Triceps", img: "assets/muscle_shoulders.png", instruction: "Hold dumbbells at shoulders, palms facing you. Press up while rotating palms to face forward, reverse the rotation lowering back down." },
    { name: "Face Pulls", type: "Gym", category: "shoulders", met: 3.5, muscle: "Shoulders (Rear), Traps", img: "assets/muscle_shoulders.png", instruction: "Set cable at face height with rope attachment. Pull rope towards face, flaring elbows wide, squeezing rear delts, then return slowly." },
    { name: "Front Raises", type: "Gym", category: "shoulders", met: 3.0, muscle: "Shoulders (Front)", img: "assets/muscle_shoulders.png", instruction: "Hold dumbbells in front of thighs. Raise arms straight forward to shoulder height, pause, then lower with control." },
    { name: "Hammer Curls", type: "Gym", category: "arms", met: 3.0, muscle: "Biceps, Forearms", img: "assets/muscle_arms.png", instruction: "Hold dumbbells with palms facing each other (neutral grip). Curl weights up towards shoulders keeping wrists neutral, then lower." },
    { name: "Skull Crushers", type: "Gym", category: "arms", met: 3.5, muscle: "Triceps", img: "assets/muscle_arms.png", instruction: "Lie on bench holding barbell/EZ-bar above chest. Bend elbows lowering bar towards forehead, then extend arms back up." },
    { name: "Concentration Curls", type: "Gym", category: "arms", met: 3.0, muscle: "Biceps", img: "assets/muscle_arms.png", instruction: "Sit, brace elbow against inner thigh holding dumbbell. Curl weight up squeezing bicep, then lower slowly with full control." }
];
...
function updateHomeDashboard() {
    ...
    document.getElementById("home-calories-burned").textContent = `${burned} / ${target} kcal`;
...
function openExerciseModal(ex) {
    ...
    imgEl.src = ex.img;
    imgEl.onerror = () => {
        imgEl.src = "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?q=80&w=200&auto=format&fit=crop"; // fallback image
    };
